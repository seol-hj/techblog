---
title: Google 클라우드 서비스와 아키텍처 설계 및 구축
draft: false
tags:
  - Cloud
  - GCP
...
- [GCP 개요](Experience/MGC_SA_Bootcamp/9_GCP/01_GCP.md)
- [리소스 계층 구조와 IAM](Experience/MGC_SA_Bootcamp/9_GCP/02_IAM.md)
- [Network](Experience/MGC_SA_Bootcamp/9_GCP/03_Network.md)
- [Compute Engine](Experience/MGC_SA_Bootcamp/9_GCP/04_Compute.md)
- [Cloud Storage](Experience/MGC_SA_Bootcamp/9_GCP/05_Storage.md)
...
- [gcloud 설치 및 인증](Experience/MGC_SA_Bootcamp/9_GCP/21_gcloud.md)
- 